...
<section class="Psection MT20">
 <article class="U-article Overflow">
  ...
  <section class="Myaddress Overflow">
   <span class="MDtitle Font14 FontW Block Lineheight35">密码修改</span>
   <form action="savePassword" method="post">
   <table>
    <tr><input type="hidden" name="userId" value="${userInfos.userId}"/></tr>
    <tr>
     <td  colspan="2" width="30%" class="Font14 FontW Lineheight35" align="center"><h3 style="color: red">${errorInfo}</h3></td>
    </tr>
    <tr>
     <td width="30%" class="Font14 FontW Lineheight35" align="right">旧密码：</td>
     <td><input type="text" name="oldPwd"  ></td>
    </tr>
    <tr>
     <td width="30%" class="Font14 FontW Lineheight35" align="right">新密码：</td>
     <td><input type="text" name="newPwd"  ></td>
    </tr>
    <tr>
     <td width="30%" class="Font14 FontW Lineheight35" align="right">确认密码：</td>
     <td><input type="text" name="comfirmPwd"  ></td>
    </tr>
    <tr>
  ...
  <%-- <!--add new address-->
   ...
   &lt;%&ndash;  <td>
    ...
    <tr>
     <td width="30%" class="Font14 FontW Lineheight35" align="right">学号：</td>
